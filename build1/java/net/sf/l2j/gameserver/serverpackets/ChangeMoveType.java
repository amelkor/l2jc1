/*
 * $Header: /cvsroot/l2j/L2_Gameserver/java/net/sf/l2j/gameserver/serverpackets/ChangeMoveType.java,v 1.3 2004/07/04 11:14:52 l2chef Exp $
 *
 * $Author: l2chef $
 * $Date: 2004/07/04 11:14:52 $
 * $Revision: 1.3 $
 * $Log: ChangeMoveType.java,v $
...
public class ChangeMoveType extends ServerBasePacket
{
	...
	public ChangeMoveType(L2Character cha, int newMoveType)
	{
		_cha = cha;
