/*
 * $Header: /cvsroot/l2j/L2_Gameserver/java/net/sf/l2j/gameserver/serverpackets/StopRotation.java,v 1.2 2004/09/28 02:44:16 nuocnam Exp $
 *
 * $Author: nuocnam $
 * $Date: 2004/09/28 02:44:16 $
 * $Revision: 1.2 $
 * $Log: StopRotation.java,v $
...
public class StopRotation extends ServerBasePacket
{
	...
	public StopRotation(L2PcInstance player, int degree)
	{
		_char = player;
		_degree = degree;
	}
