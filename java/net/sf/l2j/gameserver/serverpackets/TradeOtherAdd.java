/*
 * $Header: /cvsroot/l2j/L2_Gameserver/java/net/sf/l2j/gameserver/serverpackets/TradeOtherAdd.java,v 1.2 2004/09/28 03:01:08 nuocnam Exp $
 *
 * $Author: nuocnam $
 * $Date: 2004/09/28 03:01:08 $
 * $Revision: 1.2 $
 * $Log: TradeOtherAdd.java,v $
...
public class TradeOtherAdd extends ServerBasePacket
{
	...
	public TradeOtherAdd(L2ItemInstance x,int amount)
	{
		temp = x;
		_amount = amount;
	}	
